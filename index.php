 ...
 function build_calendar($month, $year) {
    ...
    while ($currentDay <= $numberDays) { 
        ...
        $calendar.="<td><h4>$currentDay</h4> <button class='btn btn-danger btn-xs'>N/A</button>";
            ...
            if ($totalbookings > 0) {
                $calendar.="<td class='$today' onclick='getEvents(\" " . $date . "\")';><h4>$currentDay</h4><small class='event-data'><i> $totalbookings Event</i></small>";
            }else{
                $today = $today.'-no';
                $calendar.="<td class='$today' onclick='getEvents(\" " . $date . "\")';><h4>$currentDay</h4> <small class='event-data'><i> No Event</i></small>";
            }
